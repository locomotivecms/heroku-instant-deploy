...
(function() {
  ...
  Locomotive.Views.ApplicationView = (function(superClass) {
    ...
    ApplicationView.prototype.render = function() {
      ...
      this.set_max_height();
      return this.automatic_max_height();
    };
...
(function() {
  ...
  Locomotive.Views.CurrentSite.EditView = (function(superClass) {
    ...
    EditView.prototype.initialize = function() {
      return this.attach_events_on_private_access_attribute();
    };
...
(function() {
  ...
  Locomotive.Views.Inputs.SimpleImageView = (function(superClass) {
    ...
    SimpleImageView.prototype.events = {
    ...
    SimpleImageView.prototype.render = function() {
      ...
      this.no_file_label = this.$('.file-wrapper').data('no-file-label');
      return this.initial_state = this.urls.current != null ? 'existing_file' : 'no_file';
    };

    SimpleImageView.prototype.mark_file_as_deleted = function(event) {
    ...
    SimpleImageView.prototype.update_filename = function(name) {
      if (!_.isEmpty(name)) {
